...
class User(PermissionsMixin, ModelWithMetadata, AbstractBaseUser):
    ...
    addresses = models.ManyToManyField(
        Address, blank=True, null=True, related_name="user_addresses"
    )
    is_staff = models.BooleanField(default=False)
    is_entity = models.BooleanField(default=False)
    name_org = models.CharField(max_length=256, blank=True)
    legal_addres = models.ManyToManyField(
        Address, blank=True, related_name="user_addresses_legal"
    )
    phone = models.CharField(max_length=16, blank=True)
    inn = models.CharField(max_length=12, default="000000000000")
    orgn = models.CharField(max_length=12, default="000000000000")
    kpp = models.CharField(max_length=9, default="000000000")
    bank_account = models.CharField(max_length=20, default="00000000000000000000")
    bank = models.CharField(blank=True, max_length=1000, default="Banck name")
    correspondent_bank_account = models.CharField(
        max_length=20, default="00000000000000000000"
    )
    bik = models.CharField(max_length=8, default="00000000")

...
_DEFAULT_CLIENT_HOSTS = "localhost,127.0.0.1,192.168.0.37,0.0.0.0,192.168.0.43,shop.lighted.ru,admin.lighted.ru,backend.lighted.ru"
...
INTERNAL_IPS = get_list(os.environ.get("INTERNAL_IPS", "127.0.0.1,192.168.0.37,0.0.0.0,192.168.0.43,shop.lighted.ru,admin.lighted.ru,backend.lighted.ru"))

DATABASES = {
    "default": dj_database_url.config(
        default="postgres://postgres:123456@localhost:5432/saleor", conn_max_age=600
    )
}
...
DEFAULT_COUNTRY = "US"#"RU" # os.environ.get("DEFAULT_COUNTRY", "US")
DEFAULT_CURRENCY = "USD"#"RUB" #os.environ.get("DEFAULT_CURRENCY", "USD")
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,192.168.0.37,0.0.0.0,192.168.0.43,shop.lighted.ru,admin.lighted.ru,backend.lighted.ru"))

...
class SaleInput(graphene.InputObjectType):
    ...
    periodically_change = graphene.String(require=True) # Статус менять ли скидку динамически
    value_discount = PositiveDecimal(description="Value of the discount.") # Значение скидки
    value_frequency = PositiveDecimal(description="Value of the frequency.") # Раз в сколько дней
